  ...
  return (
    <section className="page-section">
      <header className="section-header">
        ...
        <p>
          Kia ora!
          Welcome to my corner of the internet. When Instagram Reels taught me that static websites can be freely deployed on Github, I felt compelled to give it a go. I learned that very employable people in tech have blogs AND finished personal projects. Sounds ambitious, but I'm having a go.
          Enjoy my brain dumps ♥
        </p>
      </header>
      ...
      <div className="about-card">
        ...
        <p>
          I was very luckily born in Wellington, New Zealand. If there's a city-equivalent to patriotic, that's me. Although, I've ended up in Tamaki Makaurau Auckland! After 13 years of schooling at Miramar Central School, Evans Bay Intermediate School, and Wellington East Girls' College, I relocated to Auckland to study. Through AUT, I completed a Bachelor of Engineering (Honours) majoring in Software Engineering and minoring in Artifical Intelligence. I gratefully interned as a Data Engineer at Spark (Summer 22/23), an Application Developer at Treasury (Summer 23/24), and a Software Engineer at Immersve (Summer 24/25). I'm currently working as a Microservices Engineer at Araraurangi Air New Zealand through their ELEVATE Digital Graduate programme. 
        </p>
      </div>
      ...
      <footer className="page-footer">
        ...
        <li>
          <a href="https://www.linkedin.com/in/jasmineamohia/" target="_blank" rel="noopener noreferrer">
            LinkedIn
          </a>
        </li>
        <li>
